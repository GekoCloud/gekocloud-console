...
module.exports = {
  ...
  APP_TEMPLATE_DESC:
    'SmartKube provides full lifecycle management for apps. You can upload or create new app templates and test them quickly. In addition, you can publish your apps to the App Store so that other users can deploy with one click.',
  ...
  HOW_PUBLISH_APP_DESC:
    'SmartKube currently supports uploading Helm Charts through app templates within the workspace, where you can submit your template for review. Once the template is approved, you can publish it to the App Store.',

  HOW_APP_DEPLOY_TITLE: 'How to deploy and test applications',

  APPS_CREATE_DESC:
    'SmartKube provides lifecycle management of app templates. You can upload or create new app templates and test them quickly. In addition, you can publish your app templates to the App Store so that other users can deploy them.',
