...
module.exports = {
  ...
  APP_TEMPLATE_DESCRIPTION_ARTICLE:
    'SmartKube visualizes app templates and provides deployment and management function, allowing users to quickly deploy applications with one click based on app templates.',
