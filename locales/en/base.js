...
module.exports = {
  ...
  'rules desc':
    'SmartKube can collect operation audits according to the rules you set. Click to see how to define the rules.',
  ...
  USER_GUIDES_DESC: 'The most comprehensive user guide of SmartKube.',
  DEVELOPER_DESC: 'Raise a question in the developer community to get help.',
  API_DOCS_DESC: 'The most comprehensive SmartKube API documentation.',
