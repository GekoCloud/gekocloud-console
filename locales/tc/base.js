...
module.exports = {
  ...
  EVENT_DESC: '事件查詢（Event）是 SmartKube 提供的平台内資源的歷史事件查詢',
  ...
  'rules desc':
    'SmartKube可以根據您設置的規則進行操作審計的收集，點擊查看如何定義規則。',
  Category: '類别',
  Resource: '資源',
  ...
  KS_DESCRIPTION:
    'SmartKube 平台基于一个开源项目 SmartKube，在目前主流容器調度平台 Kubernetes 之上構建的企業級分佈式多租戶容器管理平台，提供簡單易用的操作界面以及引導式操作方式，在降低用戶使用容器調度平台學習成本的同時，極大降低開發、測試、維運的日常工作的複雜度。',
  ...
  USER_GUIDES_DESC: '最詳盡的 SmartKube 用戶指南文件',
  DEVELOPER_DESC: '透過在開發者社區提出問題獲得幫助',
  API_DOCS_DESC: '最詳盡的 SmartKube API 文件',
