...
function (_Component) {
  ...
  function Collapse(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleVisible", function (key, visible) {
      ...
      if (!accordion && !visible && activeKey.includes(key)) {
        (0, _remove2.default)(nextKey, function (k) {
          return k === key;
        });
      }
  ...
  (0, _createClass2.default)(Collapse, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        style: style
      }, _react.default.createElement("ul", null, this.renderChildren()));
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if ('activeKey' in nextProps && !(0, _isEqual2.default)(nextProps.activeKey, prevState.activeKey)) {
        return {
...
(0, _defineProperty2.default)(Collapse, "CollapsePanel", _CollapsePanel.default);
