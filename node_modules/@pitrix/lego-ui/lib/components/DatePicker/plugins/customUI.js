...
var customUI = function customUI() {
  return function (fp) {
    ...
    var getYears = function getYears() {
      ...
      if (minDate && !maxDate) {
        return (0, _range.default)(minDate.getFullYear(), minDate.getFullYear() + yearRange, 1);
      }

      if (!minDate && maxDate) {
        return (0, _range.default)(maxDate.getFullYear() - 20, maxDate.getFullYear() + 1, 1);
      }
      ...
      if (minDate && maxDate) {
        ...
        return (0, _range.default)(minDate.getFullYear(), maxDate.getFullYear() + 1, 1);
      }

      var localeYear = fp.now.getFullYear();
      return (0, _range.default)(localeYear - yearRange / 2, localeYear + yearRange / 2, 1);
    };
