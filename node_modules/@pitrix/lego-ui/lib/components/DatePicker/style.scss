...
.field .control .datepicker-input {
  &.input {
    &[readonly='readonly'] {
      background-color: #fff;
    }
  ...
  .flatpickr-months {
    ...
    .flatpickr-month {
      ...
      .flatpickr-header-year-month {
        ...
        &:hover {
          background-color: $datepicker-hover-background;
        }
        &.is-open {
          &:after {
      ...
      .flatpickr-dropdown {
        ...
        .dropdown-year-menu {
          ...
          span {
            ...
            text-align: center;
            &.is-active {
              color: $datepicker-selected-background;
              font-weight: 500;
            }
            &:hover {
              background-color: $datepicker-hover-background;
    ...
    .flatpickr-days {
      ...
      .dayContainer {
        ...
        .flatpickr-day {
          ...
          &.selected {
            border-color: $datepicker-selected-background;
            color: #fff;
          ...
          &.startRange {
            border-color: $datepicker-range-color;
            border-top-right-radius: 0;
            border-bottom-right-radius: 0;
            background-color: $datepicker-range-color;
            & + .inRange {
              box-shadow: -8px 0 0 $datepicker-range-color, 5px 0 0 $datepicker-range-color;
            }
            & + .endRange {
              box-shadow: 0;
            }
            ...
            & + .endRange.selected {
              box-shadow: -8px 0 0 $datepicker-range-color !important;
            }
          }
          &.endRange {
          ...
          &.inRange {
            ...
            border-radius: 0;
            background-color: $datepicker-range-color;
            box-shadow: -5px 0 0 $datepicker-range-color, 5px 0 0 $datepicker-range-color;
            &:hover {
              border-color: $datepicker-range-color;
              background-color: $datepicker-range-color;
            }
            & + .endRange {
              border-color: $datepicker-range-color;
              background-color: $datepicker-range-color;
              box-shadow: -5px 0 0 $datepicker-range-color;
              &:hover {
                border-color: $datepicker-range-color;
                background-color: $datepicker-range-color;
              }
          ...
          &.endRange.startRange + .endRange:not(:nth-child(7n + 1)) {
            box-shadow: -8px 0 0 $datepicker-range-color;
          }
        }
      }
    }
