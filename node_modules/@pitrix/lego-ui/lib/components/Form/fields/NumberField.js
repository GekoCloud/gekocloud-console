...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(NumberField, _Component);
  ...
  function NumberField(props) {
    ...
    _this.state = {
      value: !(0, _isUndefined2.default)(props.value) ? props.value : props.min
    };
    return _this;
  }
  ...
  (0, _createClass2.default)(NumberField, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          restProps = (0, _objectWithoutProperties2.default)(_this$props, ["name", "label", "value"]);
      var stateValue = this.state.value;
      return _react.default.createElement(_Layout.Control, null, _react.default.createElement(_Input.InputNumber, (0, _extends2.default)({}, restProps, {
        name: name,
        label: label,
        id: name,
        value: stateValue,
...
(0, _defineProperty2.default)(NumberField, "fieldType", 'NumberField');
(0, _defineProperty2.default)(NumberField, "propTypes", {
  // Number Input Props
