...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(TextAreaField, _Component);

  function TextAreaField(props) {
    var _this;

    (0, _classCallCheck2.default)(this, TextAreaField);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TextAreaField).call(this, props));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "getControlRef", function () {
      return _this.controlRef;
    });
  ...
  (0, _createClass2.default)(TextAreaField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Layout.Control, null, _react.default.createElement(_Input.TextArea, (0, _extends2.default)({}, restProps, {
        name: name,
        label: label,
        id: name,
        value: value,
...
(0, _defineProperty2.default)(TextAreaField, "fieldType", 'TextAreaField');
(0, _defineProperty2.default)(TextAreaField, "propTypes", {
  // TextArea Props
