...
var menuRenderer = function menuRenderer(_ref) {
  var focusedOption = _ref.focusedOption,
      ...
      getOptionRef = _ref.getOptionRef,
  ...
  if (isGroup) {
    return options.map(function (groupOption, k) {
      if (groupOption.options) {
        return _react.default.createElement("div", {
          className: "select-option-group",
          key: "option-group-".concat(groupOption.label)
        }, _react.default.createElement("p", {
          className: "group-title"
        }, groupOption.label), groupOption.options.filter(function (option) {
          return !option.hidden;
        }).map(function (option, i) {
          return renderOption(option, "".concat(k, "-").concat(i));
        }));
      }

      return renderOption(groupOption, k);
    });
  }
...
menuRenderer.propTypes = {
  ...
  getOptionRef: _propTypes.default.func,
