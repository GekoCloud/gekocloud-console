...
export default {
  ...
  HOME_APP_STORE_DESC:
    'The official App Store of Geko Cloud provides deployment and management features that allow users to quickly deploy apps with one click based on app templates.',
}
