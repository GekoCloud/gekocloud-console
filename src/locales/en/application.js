...
export default {
  ...
  APPLICATIONS_DESC:
    'An application provides users with comprehensive business functions in one package. App templates in Geko Cloud are built on the Helm packaging specification. They are delivered through a unified public or private Helm repository. An application is composed of one or more Kubernetes objects including workloads, services and ingress.',
  APP_DEPLOYMENT_DESC:
  ...
  FROM_APP_STORE_DESC:
    'From the official App Store of Geko Cloud with high-quality applications and easy deployments.',
  ...
  APP_TEMPLATES_MODAL_DESC:
    'The app template comes from the workspace and the third-party Helm app templates. It supports one click deployment and can be visualized in Geko Cloud to show and provide deployments and management functions.',
