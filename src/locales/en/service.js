...
export default {
  ...
  SERVICE_CREATE_DESC:
    'A Service is an abstraction that defines a logical collection of Pods and a strategy for accessing them. You can select the service type or how a service is created. Smartkube supports both stateful and stateless services and services can be created through codes or artifacts.',
