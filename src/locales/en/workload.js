...
export default {
  ...
  DEPLOYMENT_DESC:
    'Deployment provides fine-grained management of common applications in Geko Cloud. Deployment configuration describes the desired state of specific components of an application as Pod templates.',
