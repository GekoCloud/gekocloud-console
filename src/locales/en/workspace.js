...
export default {
  WORKSPACE_OVERVIEW_DESC:
    'Workspace provides Geko Cloud with a secure, isolated and accessible platform. Here you can see the resource running status in the current workspace.',
  ...
  NO_WORKSPACE_TIP:
    'Your account does not currently belong to any workspace. Please create one or contact the administrator to invite you to work in the workspace.',
  WORKSPACE_MEMBER_DESC:
    "Assign and manage workspace members' roles. The project can invite corporate members in the workspace as projects members.",
  ...
  DELETE_WORKSPACE_TIP:
    'Are you sure deleting the workspace <strong>{resource}</strong> ? You will not be able to recover it, and the resources under the workspace will also be deleted.',
