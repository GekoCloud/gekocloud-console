...
export default {
  ...
  KS_DESCRIPTION:
    'Smartkube está basado en un proyecto de código abierto llamado Kubesphere que tiene como objetivo proporcionar una plataforma de contenedores multi-tenant de nivel empresarial sobre Kubernetes, la plataforma de orquestación de contenedores de referencia. Smartkube proporciona una interfaz fácil de usar y permite realizar operaciones usando asistentes, reduciendo la curva de aprendizaje y el costo operativo de Kubernetes en términos del trabajo diario de desarrollo, prueba y mantenimiento.',
  REPS_ADDRESS: 'GitHub',
  ...
  'rules desc':
    'Smartkube puede recopilar registros de auditoría de operación de acuerdo con las reglas que establezcas. Haga clic para ver cómo definir las reglas.',
  EVENT_CREATE_DESC:
  ...
  USER_GUIDES_DESC: 'La guía de usuario más completa de Smartkube.',
  DEVELOPER_DESC:
    'Haz una pregunta en la comunidad de desarrolladores para obtener ayuda.',
  API_DOCS_DESC: 'La documentación más completa de la API de Smartkube.',
  GITHUB_ISSUES_DESC:
