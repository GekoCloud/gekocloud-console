...
export default {
  ...
  WORKSPACE_OVERVIEW_DESC:
    'Workspace proporciona a Geko Cloud una plataforma segura, aislada y accesible. Aquí puedes ver el estado de ejecución de los recursos en el espacio de trabajo actual.',
  WORKSPACE_DESC:
