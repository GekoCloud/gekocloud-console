...
export default {
  ...
  EVENT_DESC: '事件查詢（Event）是Smartkube提供的平台内資源的歷史事件查詢',
  ...
  KS_DESCRIPTION:
    'Smartkube 是一款開源項目，在目前主流容器調度平台 Kubernetes 之上構建的企業級分佈式多租戶容器管理平台，提供簡單易用的操作界面以及引導式操作方式，在降低用戶使用容器調度平台學習成本的同時，極大降低開發、測試、維運的日常工作的複雜度。',
