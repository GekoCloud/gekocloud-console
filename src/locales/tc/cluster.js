...
export default {
  ...
  'Please input the geko cloud api server address of the cluster':
    '請輸入待加入集群的 Geko Cloud API Server 地址',
  ...
  NO_CLUSTER_TIP_DESC:
    '集群是一組運行著 Kubernetes 的節點（物理或者虛擬機）, Geko Cloud 的功能也依靠於集群中的節點來運行',
  ...
  CLUSTER_API_SERVER_TITLE: '待加入集群的 Geko Cloud API Server',
  CLUSTER_API_SERVER_DESC: '需要添加待加入集群的 Geko Cloud API Server 地址',
