...
export default {
  APP_TEMPLATE_DESC:
    'Smartkube 提供全生命周期的应用管理，可以上传或者创建新的应用模板，并且快速部署它们，也可以通过应用商店进行发布应用。',
  APP_TEMPLATE_CREATE_DESC:
    'Smartkube 提供全生命周期的应用管理，可以上传或者创建新的应用模板，并且快速部署它们，也可以通过应用商店进行发布应用。',
  DEVELOP_APP_TITLE: '开发应用模板',
  DEVELOP_APP_DESC:
    '您可以上传 Helm Chart 或者使用 Smartkube 提供的资源编排工具进行应用模板的开发',
  HOW_PUBLISH_APP_TITLE: '如何发布已有应用',
  HOW_PUBLISH_APP_DESC:
    'Smartkube 目前支持将已有应用的 Helm Chart 上传至企业空间的应用模板，提交审核后，可以将应用发布在应用商店中。',
  ...
  RESOURCE_TOOL_DESCRIPTION:
    'Smartkube 提供了可视化的资源编排工具，您可以通过资源预编辑来创建应用模板，部署测试',
