...
export default {
  ...
  APP_TEMPLATE_DESCRIPTION_ARTICLE:
    '通过可视化的方式在 Geko Cloud 中展示并提供部署及管理功能，用户可以基于应用模板快速地一键部署应用',

  'App README': '应用介绍',

  'The app has no documentation': '该应用没有说明文档',
  'The version has no documentation': '该版本没有说明文档',
  'The app has no config file': '该应用没有配置文件',

  TOTAL_APP_REPOS: '共计 {num} 个应用仓库',

  APP_TEMPLATE_DESC:
    '应用模板相当于 Helm 应用仓库中的 Chart 模板，通过可视化的方式在 Geko Cloud 中展示并提供部署及管理功能，用户可以基于应用模板快速地一键部署应用。',
