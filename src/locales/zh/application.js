...
export default {
  ...
  'Choose existing services or create new service components to build an app':
    '选择已有服务或者新建服务组件来构建应用',
  'Deploy applications with one-click application templates provided by Geko Cloud':
  ...
  APPLICATION_TYPE_DESC:
    'Geko Cloud 支持来自于应用商店和应用仓库的应用部署(基于 Helm)，同样也支持自制应用 (Application CRD)。',
  ...
  FROM_APP_STORE_DESC:
    '来自Geko Cloud官方应用商店，提供高质量应用和简易的部署方式',
  ...
  APP_TEMPLATES_MODAL_DESC:
    '应用模板来自于企业空间和第三方的Helm应用模板，支持一键部署并可通过可视化的方式在Geko Cloud中展示并提供部署及管理的功能',
  APP_REPOS_DESC:
