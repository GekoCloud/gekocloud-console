...
export default {
  ...
  EVENT_DESC: '事件查询（Event）是Smartkube提供的平台内资源的历史事件查询',
  ...
  'rules desc':
    'Smartkube可以根据您设置的规则进行操作审计的收集，点击查看如何定义规则。',
  Category: '类别',
  Resource: '资源',
  ...
  KS_DESCRIPTION:
    'Smartkube平台基于一个开源项目 Kubesphere，在目前主流容器调度平台 Kubernetes 之上构建的企业级分布式多租户容器管理平台，提供简单易用的操作界面以及向导式操作方式，在降低用户使用容器调度平台学习成本的同时，极大降低开发、测试、运维的日常工作的复杂度。',
  ...
  USER_GUIDES_DESC: '最详尽的 Smartkube 用户指南文档',
  DEVELOPER_DESC: '通过在开发者社区提出问题获得帮助',
  API_DOCS_DESC: '最详尽的 Smartkube API 文档',
