...
export default {
  ...
  'Array has 0 entries, requires minimum of 1': '至少添加一个步骤',
  'This name has existed': '此名称已存在',
  'Please input credential name': '请输入凭证名称',
  SCM: '代码仓库',
  Review: '审核',
  ...
  "Sorry, You don't have permission to do this": '抱歉，您没有权限进行此操作',
  ...
  'Enable Delete All Resource to the deployment file':
    '删除部署文件所对应的所有资源',
