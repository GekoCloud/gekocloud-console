...
export default {
  ...
  PROJECT_CREATE_DESC:
    'Geko Cloud 中的项目对应的是 Kubernetes 的 namespace，是对一组资源和对象的抽象集合，常用来将系统内部的对象划分为不同的项目组或用户组。',
  ...
  PROJECT_TYPES_PROJECT_DESC:
    'Geko Cloud 中的项目对应的是 Kubernetes 的 namespace，是对一组资源和对象的抽象集合，可以根据不同的业务部门或者产品项目进行资源分组。',
